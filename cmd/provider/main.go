...
import (
	...
	"github.com/eaglesemanation/provider-b2/apis"
	"github.com/eaglesemanation/provider-b2/apis/v1alpha1"
	"github.com/eaglesemanation/provider-b2/config"
	"github.com/eaglesemanation/provider-b2/internal/clients"
	"github.com/eaglesemanation/provider-b2/internal/controller"
...
func main() {
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Backblaze B2 APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Backblaze B2 controllers")
